                ...
                <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <a href="form.php" class="nav-item nav-link">Add/Delete product by Admin</a>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="contact-info">
                            <h2>Our Store</h2>
                            <h3><i class="fa fa-map-marker"></i>Bashundhara, Dhaka-1229, Bangladesh</h3>
                            <h3><i class="fa fa-envelope"></i>registrar@northsouth.edu</h3>
                            <h3><i class="fa fa-phone"></i>+880-2-55668200</h3>
                            <div class="social">
